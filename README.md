...
- 黑白银灰数字展厅风格，支持浅色主题并记住选择。
- 依据原始 Logo 轮廓制作的 Three.js 银白立体云标，支持缓慢转动与桌面指针响应。
...
Three.js 0.180.0 随项目本地提供，许可证见 `vendor/THREE-LICENSE.txt`。电影卡片的极光景观为原创 AI 生成插图，不是实际电影海报或影片截图。
